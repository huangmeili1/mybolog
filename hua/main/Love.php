	...
	<div class="col-xs-6 col-md-12" style="background: white;">
		<div class="row">
			<div class="col-xs-6 col-md-12" style="background: white;width: 100%;">
				<div class="col-sm-6 col-md-3" style="width: 100%;margin: 0 auto;background: white;">
			        <img style="margin: 0 auto;width: 1282px;height: 400px;" src="https://img02.hua.com/pc/pimg/flower_bannerLove_171019.jpg" />
			    </div>
			</div>
		</div>
		<div class="row" style="width: 98%;margin: 0 auto;margin-top: 20px;">
			<div class="col-xs-6 col-md-2" style="border: 1px solid gainsboro;margin-top: 10px;margin: 0;margin-top: 20px;">
			<div style="height: 30px;line-height: 35px;text-align: center;background-color: gainsboro;width: 100%;">热销鲜花推荐</div>
								...
								<div class="thumbnail" style="text-align: center;height: 320px;border: 0;">
					                ...
					                <p>
					                	...
					                	<?php
					                		if($e['sum']==0){
					                			?>
					                			<button class="button" class="btn btn-default">库存不足</button>
					                			<?php
					                		}else{
		...
		<div class="row">
			<div id="span1" class="col-xs-6 col-md-12" style="width: 98.5%;margin-top: 10px;height: 35px;margin-left: 15px;background: white;">
					<table style="line-height: 40px;font-size: 20px;">
							<tr>
								<td width="70"><a href="Love.php" style="color: orangered;"><span id="zz">综合</span></a></td>
								<td width="70"><a href="javascript:lou('chagelove.php?type=销量','销量')"><span id="z1">销量<span class="caret"></span></span></a></td>
								<td width="70"><a href="javascript:lou('chagelove.php?type=价格','价格')"><span id="z2">价格</span></a></td>
								<td width="70"><a href="javascript:lou('chagelove.php?type=最新','最新')"><span id="z3">最新<span class="caret"></span></span></a></td>
							</tr>
					</table>
		...
		<div  class="row" style="margin-top: 25px;">
			<div class="col-xs-6 col-md-12" id="lovemain" style="width: 100%;background: white;">
				<div class="row">
					<?php
						$sql=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='鲜花') and (good_use like '%老婆%' or good_use like '%女朋友%' or good_use like '%情侣%' or festival like '%情人节%' or festival like'%结婚%' or object like '%老婆%' or object like '%女朋友%' or object like '%情侣%' or object like '%情人%')");
				    ...
				    $ps=($page-1)*$pagesize;
				    $SQL=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='鲜花') and (good_use like '%老婆%' or good_use like '%女朋友%' or good_use like '%情侣%' or festival like '%情人节%' or festival like'%结婚%' or object like '%老婆%' or object like '%女朋友%' or object like '%情侣%' or object like '%情人%') limit $ps,$pagesize");
								...
								<tr>
									<?php
										if($page<=1){
											...
											?>
											<td width="80"><a style="color: dimgrey;" href="Love.php?page=<?php echo $pr ?>"><span><上一页</span></a></td>
											<?php
										}
										?>
									<td width="35" align="center" height="40"><a href="Love.php?page=1"><span>1</span></a></td>
									<td width="35" align="center" height="40"><a href="Love.php?page=2"><span>2</span></a></td>
									<td width="35" align="center" height="40"><a href="Love.php?page=3"><span>3</span></a></td>
									<td width="35" align="center" height="40"><a href="Love.php?page=4"><span>4</span></a></td>
									<td width="35" align="center" height="40"><a href="Love.php?page=5"><span>5</span></a></td>
									<td width="35" align="center" height="40"><a href="Love.php?page=6"><span>6</span></a></td>
									<td width="35" align="center" height="40"><span>.....</span></td>
									<td width="35" align="center" height="40"><a href="Love.php?page=<?php echo $number ?>"><span><?php echo $number; ?></span></a></td>
										<?php
										if($page>=$number){
										?>
										...
										<?php	
											...
											?>
											<td width="80"><a href="Love.php?page=<?php echo $pn ?>"><span>下一页></span></a></td>
											<?php
										}
										?>
								</tr>
								...
								<tr>
									<?php
										if($page<=1){
											...
											?>
											<td width="80"><a href="Love.php?page=<?php echo $pr ?>"><span><上一页</span></a></td>
											<?php
										}
										for($i=1;$i<=$number;$i++){
											?>
											<td width="35" height="40" align="center"><a href="Love.php?page=<?php echo $i; ?>"><span><?php echo $i; ?></span></a></td>
											<?php
										}
										if($page>=$number){
										?>
