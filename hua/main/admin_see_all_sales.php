...
<?php
	...
	if(@$_SESSION['admin_id']!=''&&@$_SESSION['type']!=''&&@$_SESSION['admin_name']!=''){
		@$sql=mysql_query("select DISTINCT(acct_yr) from summary");
		...
		<div class="container" style="width: 100%;">
			<?php
				include("m_top.php");
				?>
			<div id="all_good_sales" class="row">
				<div class="col-md-12">
					<h4 style="text-align: center;">全部商品销量查询</h4>
			...
			<div id="show_table" class="row" style="margin-top: 30px;display: none;">
				<div class="col-md-12">
					<h4 style="text-align: center;">全部商品销量查询-表格形式</h4>
								<form name="form1" onsubmit="return checkForm()" method="get" action="admin_see_all_sales2.php">
								  <table width="300" border="1" align="center" cellpadding="3" cellspacing="3">
								    ...
								    <tr>
								      ...
								      <?php
								      	@$yu=mysql_query("select DISTINCT(acct_mth) from summary");
								      	?>
								    ...
								    <tr>
								      ...
								      <td><select onchange="check2()" name="end_mth" id="end_mth">
								        <?php
								        	@$yu2=mysql_query("select DISTINCT(acct_mth) from summary");
								      		$aa=-1;
			...
			<div style="display: none;" id="show_tu" class="row">
				<div class="col-md-12">
					<h4 style="text-align: center;">全部商品销量查询-图形式</h4>
								<form name="form1" onsubmit="return checkform1()" method="get" action="admin_select_sales2.php">
								  <p align="center" class="style1"> 商品销量查询</p>
								  <table width="300" border="1" align="center" cellpadding="3" cellspacing="3">
								    <tr>
								      <td width="85"><strong>查询年份</strong></td>
								      <td width="188">
