			...
			<?php include("m_top.php"); ?>
				<div class="row">
						<div class="col-md-12" style="background-color:white;height: 100px;width: 100%;">
							<form class="bs-example bs-example-form" role="form" action="admin_select_goods3.php">
				...
				<?php
					@$sql=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='永生花') order by good_time desc");
					@$num=mysql_num_rows($sql);
					if($num<=0){
						?>
						<div class="row">
							<div class="col-md-12">
								<h4 style="text-align: center;">暂无永生花</h4>
							</div>
						</div>
						<?php
					}else{
						...
						<div class="row">
							<div class="col-md-12">
								<table class="table table-hover">
									<caption style="font-size: 24px;text-align: center;"><b>永生花列表</b></caption>
									<thead>
										<tr>
											<th>商品图片</th>
											<th>商品名称</th>
									...
									<?php
									    ...
									    $ps=($page-1)*$pagesize;
									    $SQL=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='永生花') order by good_time desc limit $ps,$pagesize");
																...
																<ul class="pagination pagination-lg" style="float: right;">
																		...
																		if($page<=1){
																			...
																			<?php 
																				...
																				?>
																				<li><a href="List_goods3.php?page=<?php echo $pr; ?>">&laquo;上一页</a></li>
																				<?php
																			}
																				?>
																				
																				<li><a href="List_goods3.php?page=1">1</a></li>
																				<li><a href="List_goods3.php?page=2">2</a></li>
																				<li><a href="List_goods3.php?page=3">3</a></li>
																				<li><a href="List_goods3.php?page=4">4</a></li>
																				<li><a href="List_goods3.php?page=5">5</a></li>
																				<li><a href="List_goods3.php?page=6">6</a></li>
																				<li class="disabled"><span>.....</span></li>
																				<li><a href="List_goods3.php?page=<?php echo $number; ?>"><?php echo $number; ?></a></li>
																				<?php
																		if($page>=$number){
																		?>
																		...
																		<?php
																			...
																			?>
																			<li><a href="List_goods3.php?page=<?php echo $pn; ?>">下一页&raquo;</a></li>
																			<?php
																		}
																			?>
																		...
																		if($page<=1){
																			...
																			<?php 
																				...
																				<?php
																					for($i=1;$i<=$number;$i++){
																						?>
																						<li><a href="List_goods3.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
																						<?php
																					}
																					?>
																				<?php
