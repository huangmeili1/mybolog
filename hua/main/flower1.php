<div class="col-md-12" style="background-color: white;">
				...
				$s=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='鲜花')");
				@$n=mysql_num_rows($s);
				if($n<=0){
					?>
					<div class="col-md-12">
					...
					<?php
					    ...
					    $ps=($page-1)*$pagesize;
					    $SQL=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='鲜花') limit $ps,$pagesize");
								...
								<ul class="pagination pagination-lg" style="float: right;">
										...
										if($page<=1){
											...
											<?php 
												...
												?>
												<li><a href="javascript:lop('flower1.php?page=<?php echo $pr; ?>')">&laquo;上一页</a></li>
												<?php
											}
												?>
												
												<li><a href="javascript:lop('flower1.php?page=1')">1</a></li>
												<li><a href="javascript:lop('flower1.php?page=2')">2</a></li>
												<li><a href="javascript:lop('flower1.php?page=3')">3</a></li>
												<li><a href="javascript:lop('flower1.php?page=4')">4</a></li>
												<li><a href="javascript:lop('flower1.php?page=5')">5</a></li>
												<li><a href="javascript:lop('flower1.php?page=6')">6</a></li>
												<li class="disabled"><span>.....</span></li>
												<li><a href="javascript:lop('flower1.php?page=<?php echo $number; ?>')"><?php echo $number; ?></a></li>
												<?php
										if($page>=$number){
										?>
										...
										<?php
											...
											?>
											<li><a href="javascript:lop('flower1.php?page=<?php echo $pn; ?>')">下一页&raquo;</a></li>
											<?php
										}
											?>
										...
										if($page<=1){
											...
											<?php 
												...
												<?php
													for($i=1;$i<=$number;$i++){
														?>
														<li><a href="javascript:lop('flower1.php?page=<?php echo $i; ?>')"><?php echo $i; ?></a></li>
														<?php
													}
													?>
												<?php
