								...
								<tr>
									<?php
										if($page<=1){
											...
											?>
											<td width="80"><a style="color: dimgrey;" href="javascript:lop('bussiness1.php?page=<?php echo $pr; ?>)"><span>上一页</span></a></td>
											<?php
										}
										?>
									<td width="35" align="center" height="40"><a href="javascript:lop('bussiness1.php?page=1')"><span>1</span></a></td>
									<td width="35" align="center" height="40"><a href="javascript:lop('bussiness1.php?page=2')"><span>2</span></a></td>
									<td width="35" align="center" height="40"><a href="javascript:lop('bussiness1.php?page=3')"><span>3</span></a></td>
									<td width="35" align="center" height="40"><a href="javascript:lop('bussiness1.php?page=4')"><span>4</span></a></td>
									<td width="35" align="center" height="40"><a href="javascript:lop('bussiness1.php?page=5')"><span>5</span></a></td>
									<td width="35" align="center" height="40"><a href="javascript:lop('bussiness1.php?page=6')"><span>6</span></a></td>
									<td width="35" align="center" height="40"><span>.....</span></td>
									<td width="35" align="center" height="40"><a href="javascript:lop('bussiness1.php?page=<?php echo $number; ?>')"><span><?php echo $number; ?></span></a></td>
										<?php
										if($page>=$number){
										?>
										...
										<?php	
											...
											?>
											<td width="80"><a href="javascript:lop('bussiness1.php?page=<?php echo $pn; ?>')"><span>下一页></span></a></td>
											<?php
										}
										?>
								</tr>
								...
								<tr>
									<?php
										if($page<=1){
											...
											?>
											<td width="80"><a href="javascript:lop('bussiness1.php?page=<?php echo $pr ?>')"><span>上一页</span></a></td>
											<?php
										}
										for($i=1;$i<=$number;$i++){
											?>
											<td width="35" height="40" align="center"><a href="javascript:lop('bussiness1.php?page=<?php echo $i; ?>')"><span><?php echo $i; ?></span></a></td>
											<?php
										}
										if($page>=$number){
										?>
