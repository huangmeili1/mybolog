<div class="row" style="width: 100%;margin: 0 auto;background-color: white;">
		<?php
			...
			@$type=$_GET['type'];
			if($type=='盒'){
				$sql=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='鲜花') and packing like '%$type%'");
			}else{
			...
			if($num<=0){
				...
				<?php
					    ...
					    $ps=($page-1)*$pagesize;
					    if($type=='礼盒'){
					    	$SQL=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='鲜花') and packing like '%$type%' limit $ps,$pagesize");
					    }else{
					    $SQL=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='鲜花') and material like '%$type%' limit $ps,$pagesize");	
					    } 
								...
								?>
										...
										if($page<=1){
											...
											<?php 
												...
												?>
												<li><a href="javascript:lop('category1.php?page=<?php echo $pr; ?>&type=<?php echo $type; ?>')">&laquo;上一页</a></li>
												<?php
											}
												?>
												
												<li><a href="javascript:lop('category1.php?page=1&type=<?php echo $type; ?>')">1</a></li>
												<li><a href="javascript:lop('category1.php?page=2&type=<?php echo $type; ?>')">2</a></li>
												<li><a href="javascript:lop('category1.php?page=3&type=<?php echo $type; ?>')">3</a></li>
												<li><a href="javascript:lop('category1.php?page=4&type=<?php echo $type; ?>')">4</a></li>
												<li><a href="javascript:lop('category1.php?page=5&type=<?php echo $type; ?>')">5</a></li>
												<li><a href="javascript:lop('category1.php?page=6&type=<?php echo $type; ?>')">6</a></li>
												<li class="disabled"><span>.....</span></li>
												<li><a href="javascript:lop('category1.php?page=<?php echo $number; ?>&type=<?php echo $type; ?>')"><?php echo $number; ?></a></li>
												<?php
										if($page>=$number){
										?>
										...
										<?php
											...
											?>
											<li><a href="javascript:lop('category1.php?page=<?php echo $pn; ?>&type=<?php echo $type; ?>')">下一页&raquo;</a></li>
											<?php
										}
											?>
										...
										if($page<=1){
											...
											<?php 
												...
												<?php
													for($i=1;$i<=$number;$i++){
														?>
														<li><a href="javascript:lop('category1.php?page=<?php echo $i; ?>&type=<?php echo $type; ?>')"><?php echo $i; ?></a></li>
														<?php
													}
													?>
												<?php
