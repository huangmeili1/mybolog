...
<div style="margin: 0 auto;text-align: center;width: 100%;height: 100%;">
	...
	<div id="aa" style="margin: 0 auto;text-align: center;height: 100%;width: 85%;float: right;">
		<form method="post" enctype="multipart/form-data">
			<table align="center" style="margin-top: 150px;margin-left: 340px;">
				...
				<tr>
					<td>付款方式名称：</td>
					<td><input type="text" required="required" name="name" value="<?php echo @$_POST['name'] ?>" size="50" style="height: 35px;"></td>
				</tr>
				<tr>
					<td>付款类型：</td>
					<td><input type="text" required="required" name="ty" value="<?php echo @$_POST['ty'] ?>" size="50" style="height: 35px;"></td>
				</tr>
				<tr>
					<td>付款方式帐号：</td>
					<td><input type="text" required="required" required="required" name="no" value="<?php echo @$_POST['no'] ?>" size="50" style="height: 35px;"></td>
				</tr>
				<tr>
					<td>开户人：</td>
					<td><input type="text" required="required" name="user" value="<?php echo @$_POST['user'] ?>" size="50" style="height: 35px;"></td>
				</tr>
				<tr>
					<td>付款方式图片:</td>
	...
	if(isset($_POST['tj'])){
		...
		if(($y!='jpg'&&$y!='jpge'&&$y!='png')&&($y!='JPG'&&$y!='JPGE'&&$y!='PNG')){
			...
			$sql=mysql_query("insert into getmoney(get_money,get_img,get_mo,get_type,get_user) values('$name','$man_img','$no','$ty','$user')");
