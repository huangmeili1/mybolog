...
<?php
									...
									$sql=mysql_query("select * from comments where user_id='$user_id' order by comment_time desc");
									...
									if(@$num<=0){
										...
										<table class="table table-hover">
											<caption><b>按时间正序<span class="glyphicon glyphicon-arrow-up"></span></b></caption>
											<thead>
												<th>被评价商品</th>
												<th>评价内容</th>
												<th>评价星级</th>
											...
											<?php
											    ...
											    $ps=($page-1)*$pagesize;
												$SQL=mysql_query("select * from comments where user_id='$user_id' order by comment_time desc limit $ps,$pagesize");
																		...
																		<ul class="pagination pagination-lg" style="float: right;">
																				...
																				if($page<=1){
																					...
																					<?php 
																						...
																						?>
																						<li><a href="javascript:lop('0.php?page=<?php echo $pr; ?>')">&laquo;上一页</a></li>
																						<?php
																					}
																						?>
																						
																						<li><a href="javascript:lop('0.php?page=1')">1</a></li>
																						<li><a href="javascript:lop('0.php?page=2')">2</a></li>
																						<li><a href="javascript:lop('0.php?page=3')">3</a></li>
																						<li><a href="javascript:lop('0.php?page=4')">4</a></li>
																						<li><a href="javascript:lop('0.php?page=5')">5</a></li>
																						<li><a href="javascript:lop('0.php?page=6')">6</a></li>
																						<li class="disabled"><span>.....</span></li>
																						<li><a href="javascript:lop('0.php?page=<?php echo $number; ?>')"><?php echo $number; ?></a></li>
																						<?php
																				if($page>=$number){
																				?>
																				...
																				<?php
																					...
																					?>
																					<li><a href="javascript:lop('0.php?page=<?php echo $pn; ?>')">下一页&raquo;</a></li>
																					<?php
																				}
																					?>
																				...
																				if($page<=1){
																					...
																					<?php 
																						...
																						<?php
																							for($i=1;$i<=$number;$i++){
																								?>
																								<li><a href="javascript:lop('0.php?page=<?php echo $i; ?>')"><?php echo $i; ?></a></li>
																								<?php
																							}
																							?>
																						<?php
