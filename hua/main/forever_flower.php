...
<div class="container" style="width: 100%;">
	<?php include("top.php"); ?>
		<div class="row" style="width: 80%;height: 150px;margin: 0 auto;">
			<div class="col-md-12" style="padding: 0;">
				<div class="thumbnail" style="border: 0;padding: 0;height: 150px;">
					<img style="height: 150px;" src="../img/ysh-banner.jpg" />
				</div>
			</div>
		</div>
		...
		<div id="show_goods" class="row" style="width: 80%;margin: 0 auto;height: auto;margin-top: 20px;">
			<?php
				@$sql=mysql_query("select * from goods where kind_id=(select kind_id from kind where kind_name='永生花')");
				@$sql_num=mysql_num_rows($sql);
				if(@$sql_num<=0){
					?>
					<div class="col-md-12">
						<span style="text-align: center;">暂无永生花<a class="btn btn-danger" href="flower.php">查看其他鲜花</a></span>
					</div>
					<?php
				}else{
